...
import client.command.commands.gm0.BankCommand;
import client.command.commands.gm0.ChangeLanguageCommand;
import client.command.commands.gm0.CollectionCommand;
...
import client.command.commands.gm0.PetCommand;
import client.command.commands.gm0.QolCommand;
...
import client.command.commands.gm0.ScrollStashCommand;
...
import client.command.commands.gm0.SpawnBotCommand;
import client.command.commands.gm0.SpawnCommand;
import client.command.commands.gm0.TakeBotOwnerCommand;
...
public class CommandsExecutor {
    ...
    private void registerLv0Commands() {
        ...
        addCommand("takebot", TakeBotOwnerCommand.class);
        addCommand("bank", BankCommand.class);
        addCommand("pet", PetCommand.class);
        addCommand("qol", QolCommand.class);
        addCommand("cc", CollectionCommand.class);
        addCommand("scroll", ScrollStashCommand.class);
